...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="/web/images/ProjeFoto.jpg" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="index.html">Görkem Kayı</a></h1>
            <p class="top_hdp mt-2">Elektronik Ve haberleşme Mühendisi</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
    ...
    <div class="main">
        ...
        <section class="wedo" id="contact">
            ...
            <div style="margin-top:15px">
                <a href="login.aspx" class="btn btn-danger btn-block">Admin Paneline Gitmek İçin Tıkla</a>
            </div>
